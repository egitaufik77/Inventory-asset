            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li class="<?=is_same(3,$menu,"active")?>">
                        <a href="mutasi/penerimaan"><i class="fa fa-fw fa-bars"></i> Rekap Stok Consumable IT</a>
                    </li>
                    <li class="<?=is_same(4,$menu,"active")?>">
                        <a href="mutasi/pengiriman"><i class="fa fa-fw fa-picture-o"></i> Rekap Penggunaan per Divisi</a>
                    </li>
